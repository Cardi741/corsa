document.addEventListener('DOMContentLoaded', () => {
    ...
    // Modalità Queue: utilizza i round nella coda
    ...
    // Funzione Avvia/Pausa timer per l'allenamento normale
    function startTimer() {
      if (isRunning) {
        clearInterval(timerInterval);
        isRunning = false;
        ...
        // Se la coda contiene dei round, usa la modalità Queue, altrimenti modalità standard
    ...
    function startRapidita() {
      ...
      // Genera un tempo casuale in secondi nell'intervallo
    ...
    // Accordion behavior: al click l'elemento successivo si espande o contrae
